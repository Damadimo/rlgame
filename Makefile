...
.PHONY: all clean parity policy_smoke policy_duel_smoke policy_alt_smoke

all: tests/parity_steps tests/policy_smoke tests/policy_duel_smoke tests/policy_alt_smoke
...
policy_alt_smoke: tests/policy_alt_smoke
...
tests/policy_alt_smoke: tests/policy_alt_smoke.c firmware/solo/policy_alt.c
	$(CC) $(CFLAGS) -o $@ tests/policy_alt_smoke.c firmware/solo/policy_alt.c -lm

clean:
	rm -f tests/parity_steps tests/policy_smoke tests/policy_duel_smoke tests/policy_alt_smoke
